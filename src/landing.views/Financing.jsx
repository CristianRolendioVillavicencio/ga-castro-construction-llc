    ...
    return (
        <AnimatedElement>
            ...
            <section className="relative">
                <img src="/image/Banner 4.jpg" className="absolute w-full h-full object-cover" />
                <div className="absolute inset-0 bg-black/10 backdrop-blur-sm" />
                <div className="relative flex justify-center px-[--padding] py-48">
                    <div className="flex flex-col w-full max-w-[700px] gap-5 justify-center items-center bg-white/40 rounded-xl shadow-md p-10">
                        <h4 className="font-title2 font-bold text-2xl sm:text-5xl text-center text-balance">
                            Access a completely free quote now!
                        </h4>
                        <p className="font-title2 font-bold opacity-80 text-lg sm:text-2xl text-center text-balance">
                            Our Hearth system makes it easy for us to offer you accurance and
                            immediate quotes
                        </p>
                        <div className="flex gap-5 justify-center items-center">
                            <img className="max-w-32" src="/img/hearth.png" />
                            <Button
                                as="a"
                                style="6"
                                href="https://app.gethearth.com/partners/ga-castro-construction-llc/jeison/apply"
                                ...
                                className="font-title2 items-center  "
                            >
                                <span className="font-title sm:text-2xl">Go Quote</span>
                                <FontAwesomeIcon className="sm:text-xl" icon={faPaperPlane} />
                            </Button>
                        </div>
                    </div>
                </div>
...
//                 Options marked with an asterisk (<span className="text-red-700">*</span>) are
//                 required
//             </h3>
...
//                     <li>
//                         I, the above-named individual, have read and consent to GA Castros Terms for
//                         Electron- ic Transactions, Signatures and Records, Terms of Use, and Privacy
//                         Policy.
//                     </li>
//                     <li>
//                         I am granting GA Castro Constructions LLC my written consent under the Fair
//                         Credit Reporting Act to share information I supply with banks and other
//                         lending partners for purposes of obtaining financing for my home improvement
//                         project and to obtain credit report from one or more credit reporting
//                         agencies to show me rates and credit terms I may prequalify for when
//                         obtaining financing for home improvement projects. GA Castro Constructions
//                         LLC Will not charge any fee to a consumer for the submission of the
//                         prequalification form or the use of GA Castro&apos;s credit marketplace.
//                     </li>
//                     <li>
//                         I agree that GA Castro Constructions LLC may share this information along
//                         with all information previously provided on an aggregated and de-identified
//                         bases with GA Castro Constructions LLC and their partners, and G.A Castro
//                         Construction LLC and that G.A Castro Construction LLC may contact me by
//                         phone, text messages or emails
//                     </li>
//                 </ul>

//                 <div className="flex flex-col gap-2 py-10">
//                     <label htmlFor="terms1" className="flex flex-row gap-2">
//                         <input type="checkbox" id="terms1" /> <p>I agree to the terms above.</p>
//                     </label>
...
//                         </div>
//                         <p>
//                             I agree that GA Castro Constructions LLC may share this information
//                             along with all information previously provided on an aggregated and
//                             de-identified bases with GA Castro Constructions LLC and their partners,
//                             and G.A Castro Construction LLC and that G.A Castro Construction LLC may
//                             contact me by Phon e, text messages or emails. Reply STOP to stop
...
//                     >
//                         <span className="sm:text-xl font-title2">Ask for information</span>{" "}
