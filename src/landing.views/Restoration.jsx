...
export default function Restoration() {
    return (
        <div
            style={{
                background:
                    "linear-gradient(to bottom, rgba(0, 0, 0, 0.7), rgba(255, 255, 255, 0))",
            }}
        >
            <AnimatedElement>
                        ...
                        <div className="flex flex-col gap-10 md:flex-row md:gap-0 items-center ">
                            ...
                            <div className="flex-1">
                                <p className="font-title text-center md:text-start text-balance lg:pr-40">
                                    Fire damage or smoke damage? Restoration Local is the #1 network
                                    of restoration professions and we have qualified fire damage
                                    restoration contractors in your neighborhood. From kitchen fires
                                    to furnace puffbacks, they Will clean smoke and soot damage and
                                    restore your property to its original condition. They even
                                    remove water from fire fighting efforts and treat against mold.
                                </p>
                            </div>
                        </div>
                        <img
                ...
                <section className="relative  overflow-hidden px-[--padding]">
                    <div className="container">
                        ...
                        <div className="flex flex-col lg:flex-row justify-center gap-10 pt-20 mb-20">
                            ...
                            <Item
                                src="/new/Wind Damage.jpeg"
                                title="Wind Damage"
                                to="./water-damage"
                            />
                            <Item
                                src="/new/Tree Damage.jpg"
                                title="Tree Damage"
                                to="./tree-damage"
                            />
                        </div>
                            ...
                            <div className="flex-1 ">
                                <div className="flex flex-col font-title gap-8 text-3xl text-center sm:text-start opacity-80 pb-10 sm:pb-0">
                                    ...
                                    <p>
                                        ...
                                        Water Damage, Flood, Fire, Storm, Sewage, and Mold
                                        Remediation. We have over 14 years of experience in this
                                        industry and have helped thousands of home and business
                                        owners in restoring their property to pre-loss condition.
                                    </p>
                                    <p>
                                        We guarantee our work and have handpicked our staff so that
                                        we never lose that &quot;personal attention&quot; that you
                                        rarely receive in this industry today.
                                    </p>
                                    <p>
